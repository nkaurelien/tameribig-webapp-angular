...
export const ImagesExplorerPath = 'images';
export const ImagePresenterPath = ':uid';
...
export const ImagesExplorerUrl = `/${MODULE}/${ImagesExplorerPath}`;
export const ImagePresenterUrl = `/${MODULE}/${ImagesExplorerPath}/${ImagePresenterPath}`;
